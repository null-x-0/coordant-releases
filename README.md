...
<p align="center"><a href="https://github.com/null-x-0/coordant-releases/releases/latest"><strong>Download for macOS →</strong></a> · <a href="https://github.com/null-x-0/coordant-releases/releases">Release notes</a> · <a href="https://github.com/null-x-0/coordant-releases/issues">Report an issue</a></p>

Coordant brings your coding agents, terminals, and project tools into a desktop workspace.

- Work with Codex and Grok using your own CLI accounts.
